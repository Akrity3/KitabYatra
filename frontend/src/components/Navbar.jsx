...
import { BookOpen, Menu, X, Settings, Bell, ShoppingCart, User, LogOut } from 'lucide-react';
                ...
                {user ? (
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center space-x-2 w-full px-3 py-2 text-gray-300 hover:text-yellow-400 transition-colors rounded-lg hover:bg-gray-800 justify-between"
                    >
                  ...
                  <>
                    ...
                    <button
                      onClick={handleAdminClick}
                      className="flex items-center space-x-2 w-full px-3 py-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-gray-800 mt-2"
                    >
                      <Settings className="w-5 h-5" />
